  ...
  return (
    <html lang="en" className={inter.variable}>
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `(function(){var l=document.createElement('link');l.rel='manifest';l.href='/site.webmanifest';document.head.appendChild(l)})()` }} />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([
          { '@context': 'https://schema.org', '@type': 'Organization', name: 'TerraLogic AI', url: BASE_URL, logo: `${BASE_URL}/favicon.svg`, sameAs: [] },
          { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'TerraLogic Forge', description: 'AI-powered precision agriculture platform', url: BASE_URL, applicationCategory: 'BusinessApplication', aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', ratingCount: '245' } },
