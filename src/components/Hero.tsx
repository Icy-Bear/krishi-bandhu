      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        <div className="animate-fade-in-up">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-xl mb-12 font-medium leading-relaxed">
            Harness AI-driven yield forecasting and real-time market
            intelligence to cultivate with scientific precision.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              onClick={() =>
                (window.location.href =
                  "https://krishibandhudashboard.netlify.app/")
              }
              className="bg-emerald-900 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-emerald-800 transition-all flex items-center justify-center gap-2"
            >
              Get Started
              <svg
                className="w-5 h-5"
            ...
            <button className="bg-white border-2 border-emerald-200 text-emerald-900 px-10 py-4 rounded-xl font-bold text-lg hover:bg-emerald-50 transition-all">
              View Docs
            </button>
          </div>
          ...
          <div className="relative w-full aspect-square flex items-center justify-center animate-float">
            ...
            <div className="relative z-10 w-80 h-80">
              ...
              >
                ...
                />
                <defs>
                  <linearGradient id="g1" x1="100" y1="20" x2="100" y2="80">
                    <stop stopColor="#003527" />
                    <stop offset="1" stopColor="#2b6954" />
                  </linearGradient>
                  <linearGradient id="g2" x1="100" y1="120" x2="100" y2="180">
                    <stop stopColor="#2b6954" />
                    <stop offset="1" stopColor="#95d3ba" />
                  </linearGradient>
                  <linearGradient id="g3" x1="40" y1="100" x2="160" y2="100">
                    <stop stopColor="#003527" />
